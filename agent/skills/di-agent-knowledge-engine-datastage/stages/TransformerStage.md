...
- [String handling functions](TransformerStageFunctions/String.md)
- [String masking functions](TransformerStageFunctions/StringMasking.md)
- [String encoding functions](TransformerStageFunctions/StringEncoding.md)
...
- [Date and Time functions](TransformerStageFunctions/DateAndTime.md)
...
- [Numeric functions](TransformerStageFunctions/Numeric.md)
- [Mathematical functions](TransformerStageFunctions/Mathematical.md)
